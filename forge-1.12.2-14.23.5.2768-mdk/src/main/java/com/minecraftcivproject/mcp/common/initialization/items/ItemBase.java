...
public class ItemBase extends Item implements IHasModel {    // MP: Class is somewhat comparable to a structure in C; String is a wrapper on a character array
    ...
    }       // MP: What I think the explanation is: there are two constructors for ItemBase.  If the maxSize (stack) is not specified the object is created using the above constructor.
